...
public class ControllerKenyaImplServiceLocator extends org.apache.axis.client.Service implements ControllerKenyaImplService {
    ...
    public ControllerKenyaImplServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for ControllerKenyaImplPort
    private String ControllerKenyaImplPort_address = "file:///Users/paulmuriithi/Projects/JavaEclipse/TransUnion/src/resources/ke.wsdl_1.wsdl";

    public String getControllerKenyaImplPortAddress() {
        return ControllerKenyaImplPort_address;
    }

    // The WSDD service name defaults to the port name.
    private String ControllerKenyaImplPortWSDDServiceName = "ControllerKenyaImplPort";

    public String getControllerKenyaImplPortWSDDServiceName() {
        return ControllerKenyaImplPortWSDDServiceName;
    }

    public void setControllerKenyaImplPortWSDDServiceName(String name) {
    ...
    public void setControllerKenyaImplPortEndpointAddress(String address) {
