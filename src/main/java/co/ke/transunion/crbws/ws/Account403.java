...
public class Account403  implements java.io.Serializable {
    ...
    /**
     * Gets the balanceAmount value for this Account403.
     * 
    ...
    /**
     * Sets the balanceAmount value for this Account403.
     * 
     * @param balanceAmount
     */
    ...
    /**
     * Gets the category value for this Account403.
     * 
     * @return category
     */
    ...
    /**
     * Sets the category value for this Account403.
     * 
     * @param category
     */
    ...
    /**
     * Gets the subscriberShortCode value for this Account403.
     * 
    ...
    /**
     * Sets the subscriberShortCode value for this Account403.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof Account403)) return false;
        Account403 other = (Account403) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Account403.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.crbws.transunion.ke.co/", "account403"));
