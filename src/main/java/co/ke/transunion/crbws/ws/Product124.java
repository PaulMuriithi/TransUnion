...
public class Product124  implements java.io.Serializable {
    private Account124[] accountList;
     ...
     * @return accountList
     */
    public Account124[] getAccountList() {
        return accountList;
    }
     ...
     * @param accountList
     */
    public void setAccountList(Account124[] accountList) {
        this.accountList = accountList;
    }

    public Account124 getAccountList(int i) {
        return this.accountList[i];
    }

    public void setAccountList(int i, Account124 _value) {
